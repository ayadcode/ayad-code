                  ...
                  <div className="slugbloginfopub">
                    <div className="flex gap-2">
                      <div className="adminslug">
                        <img src="/img/coder.png" alt="mohamed ayad" />
                ...
                <div className="rightsitedetails">
                  ...
                  <div className="rightslugcategory">
                    ...
                    <ul>
                      <Link href="/blogs/category/Web Development">
                        <li>
                          ...
                          <span>
                            ...
                            {
                              alldata.filter(
                                (ab) => ab.blogcategory[0] === "Web Development"
                              ).length
                            }
                            )
                          </span>
                      ...
                      <Link href="/blogs/category/UI-UX Design">
                        <li>
                          UI/UX Design
                          <span>
                            (
                            {
                              alldata.filter(
                                (ab) => ab.blogcategory[0] === "UI-UX Design"
                              ).length
                            }
                            )
                          </span>
                      ...
                      <Link href="/blogs/category/Graphic Design">
                        <li>
                          Graphic Design
                          <span>
                            (
                            {
                              alldata.filter(
                                (ab) => ab.blogcategory[0] === "Graphic Design"
                              ).length
                            }
                            )
                          </span>
                      ...
                      <Link href="/blogs/category/AI-technology">
                        <li>
                          AI technology
                          <span>
                            (
                            {
                              alldata.filter(
                                (ab) => ab.blogcategory[0] === "AI technology"
                              ).length
                            }
                            )
                          </span>
